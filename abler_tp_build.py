...
src_path = "./release/scripts/addons_abler/page_transparency"
dest_path_ending = "2.96/scripts/addons_abler/page_transparency"
dest_path = ""
...
try:
    ...
    print("Successfully copied scripts from addons_abler/page_transparency")
