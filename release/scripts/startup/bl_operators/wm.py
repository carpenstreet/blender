...
class URLs_En(URLs_Base):
    ...
    OPERATING_ABLER = "https://guide.abler.world/en"
...
class URLs_Ko(URLs_Base):
    ...
    OPERATING_ABLER = "https://guide.abler.world"
...
class URLs_Ja(URLs_Base):
    ...
    OPERATING_ABLER = "https://guide.abler.world/ja"
...
class URLs_Zh(URLs_Base):
    ...
    OPERATING_ABLER = "https://guide.abler.world/zh"
